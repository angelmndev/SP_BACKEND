...
const createUsuario = async (req, res) => {
    let { usuNombre, usuApellido, usuUsuario, usuPassword, usuEstado, idRolFK, idSedeFK } = req.body;

    console.log( usuNombre, usuApellido, usuUsuario, usuPassword, usuEstado, idRolFK, idSedeFK);
    //hash password
    usuPassword = await passwordHash(usuPassword)
